...
**references** has the reference materials and typically, it contains my hand-in materials, which records my research thoughts
**src** is the source file folder. The algorithm Implementation
**test_result** presents the test result ot my implementation
